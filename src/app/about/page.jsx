    ...
    return (
        ...
        <main className={styles.about}>
            ...
            <div className={styles.first_screen}>
                ...
                <span className={styles.bot_title}>ТОРГОВЫЙ БОТ AMI FINANCE</span> <br />
                <span className={styles.bot_title}>Управление вашими 
                        активами искусственным 
                        интеллектом</span>
                </div>
                            ...
                            <div className={styles.coin_block}>
                                <div className={styles.coin_top}>
                                    <div className={styles.coin_title_block}>
                                        <span className={styles.coin_title}>ПОДКЛЮЧИМ ТОРГОВОГО БОТА</span> <br />
                                        <span className={styles.coin_title}>ЛУЧШИМ КРИПТО<wbr></wbr>СЕРВИСАМ</span>
                                    </div>
                                    <span className={styles.coin_txt}>с помощью API-интеграции</span>
                                </div>
                                <div className={styles.coin_low}>
                                    <p className={styles.coin_desc}>Вы сможете доверить сделки умному боту, 
                                    работа которого основана на искусственном 
                                    интеллекте</p>
                                    <button className={styles.coin_button}>
                                        <span className={styles.coin_button_txt}>Подключить бота</span>
                    ...
                    <div className={styles.digit_decoration}>
                        <div className={styles.digit_container}>
                            <div className={styles.digit_text_block}>
                                <span className={styles.digit_text}>ТОРГОВЫЙ БОТ</span> <br />
                                <span className={styles.digit_text}>AMI FINANCE</span> <br />
                            ...
                            <div className={styles.digit_block}>
                                <div className={styles.digit_block_container}>
                                    ...
                                    <p className={styles.digit_crit_txt}>ЗАШИТА КАПИТАЛА <br /> КАПИТАЛА</p>
                                </div>
                            </div>
                            <div className={styles.digit_block}>
                                <div className={styles.digit_block_container}>
                ...
                <div className={styles.fourth_scheme}>
                    <div className={styles.bot_part}>
                        <div className={styles.button_block}>
                            <img className={styles.button_img} src="./img/button.png" alt="button" />
                            <img className={styles.button_on_f} src="./img/btn-on1.png" alt="btn" />
                            <img className={styles.button_on_s} src="./img/btn-on2.png" alt="btn" />
                        </div>
                        
                        <div className={styles.but_decoration}>
                            <div className={styles.but_container}>
                                <p className={styles.but_header}>ПОДКЛЮЧИТЬСЯ
                                    К ТОРГОВОМУ БОТУ 
                                    AMI FINANCE</p>
