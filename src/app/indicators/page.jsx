                  ...
                  <div className={styles.ami_container}>
                    <div className={styles.ami_top}>
                      <div>
                        ...
                        <p className={styles.ami_desc}>
                          Наша цель – стать самым высокодоходным инвестиционным
                          фондом в мире
                        </p>
                      </div>
                    ...
                    <div className={styles.ami_down}>
                      <p className={styles.ami_txt}>
                        <span>AMI FINANCE</span> – закрытое сообщество, которое
                        помогает своим клиентам сохранять и приумножать капитал
                      </p>
                      <button className={styles.ami_button}>
                        ...
                        >
                          <path
                            opacity="0.25"
                            d="M17.7635 0.736483C17.7635 0.460341 17.5396 0.236484 17.2635 0.236483L12.7635 0.236483C12.4873 0.236483 12.2635 0.46034 12.2635 0.736483C12.2635 1.01263 12.4873 1.23648 12.7635 1.23648L16.7635 1.23648L16.7635 5.23648C16.7635 5.51263 16.9873 5.73648 17.2635 5.73648C17.5396 5.73648 17.7635 5.51263 17.7635 5.23648L17.7635 0.736483ZM1.35355 17.3535L17.617 1.09004L16.9099 0.38293L0.646447 16.6464L1.35355 17.3535Z"
                            fill="white"
                          />
                        </svg>
                      </button>
                ...
                <div className={styles.ami_decoration}>
                  <div className={styles.ami_container}>
                    <div className={styles.key_top}>
                      ...
                      <p className={styles.key_desc}>
                        является первым и единственным фондом, открывающим
                        физическим лицам доступ в мир высокодоходных финансовых
                        инструментов
                      </p>
                      <p className={styles.key_txt}>
                        Наша команда профессиональных трейдеров и аналитиков
                        стабильно генерирует прибыль как через классический
                        фондовый рынок, так&nbsp;и через рынок цифровых активов
                      </p>
                    </div>
                    <div className={styles.key_down}>
                      <p className={styles.key_txt}>
                        Наша миссия – мы помогаем почувствовать уверенность в
                        завтрашнем дне, реализовать свои мечты и ощутить свободу
                        через повышение качества жизни
                      </p>
                  ...
                  <div className={styles.digit_container}>
                    ...
                    <div className={styles.digit_block}>
                      <div className={styles.digit_block_container}>
                        ...
                        <p className={styles.digit_crit_txt}>
                          ПРОФЕССИОНАЛЬНЫХ <br /> ИНВЕСТОРОВ И АНАЛИТИКОВ
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className={styles.ami_decoration}>
                  <div className={styles.ami_container}>
                    <div className={styles.sal_top}>
                      <p className={styles.sal_header}>
                        НАШИ ИНВЕСТОРЫ ЗАРАБОТАЛИ БОЛЕЕ <br />
                        <span>$10 000 000</span>
                      </p>
                    </div>
                    <div className={styles.sal_low}>
                      <div className={styles.sal_block}>
                        <span className={styles.sal_block_txt}>10%+</span>{" "}
                        <br />
                        <span className={styles.sal_block_dec}>
                          стабильная <br /> ежемесячная <br /> доходность
                        </span>
                      </div>
                      <div className={styles.sal_block}>
                        <span className={styles.sal_block_txt}>100%</span>{" "}
                        <br />
                        <span className={styles.sal_block_dec}>
                          защита <br /> инвестиций
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <div className={styles.ami_decoration}>
                  <div className={styles.ami_container}>
                    <p className={styles.robot_header}>
                      ИСПОЛЬЗУЕМ <br />
                      <span>
                        ИСКУССТВЕН<wbr></wbr>НЫЙ ИНТЕЛЛЕКТ
                      </span>{" "}
                      <br />В ТОРГОВЫХ СТРАТЕГИЯХ
                    </p>
